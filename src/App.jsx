...
export default function AboutMe() {
  return (
    <div className="min-h-screen bg-white text-slate-900 text-left">
      {/* Header */}
      <header className="max-w-2xl px-6 pt-12">
      ...
      <main className="max-w-2xl px-6 py-10">
        ...
        <section className="mb-10">
          ...
          <p className="leading-relaxed text-slate-700">
            ...
            because I wanted to build things people actually open, and I have
            been slowly figuring out what part of that I enjoy most. So far it
